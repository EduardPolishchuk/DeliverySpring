...
<h2 class="display-3" style="color: #000000; background-color: rgba(255,238,231,0.87)"><fmt:message
        key="registration"/></h2>
                ...
                <div class="card-body">
                    ...
                    <form:form modelAttribute="userForm" method="post"
                        ...
                        <div class="mb-2 ">
                            ...
                            <form:input type="text" class="form-control" name="email" value="${param.email}"
                                        path="email"/>
                        </div>
                        <div class="mb-2 ">
                            <label class="form-label"><fmt:message key="firstName"/> </label>
                            <form:input type="text" class="form-control" name="firstName" value="${param.firstName}"
                                        path="firstName"/>
                        </div>
                        <div class="mb-2 ">
                            <label class="form-label"><fmt:message key="lastName"/></label>
                            <form:input type="text" class="form-control" name="lastName" value="${param.lastName}"
                                        path="lastName"/>
                        </div>
                        <div class="mb-2">
                            <label for="exampleInputPassword1" class="form-label"><fmt:message key="password"/> </label>
                            <form:input type="password" class="form-control" id="exampleInputPassword1" name="password"
                                        path="password"/>
                        </div>
